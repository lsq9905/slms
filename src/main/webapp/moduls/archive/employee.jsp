	...
	<table border="0" cellpadding="0" cellspacing="0" width="95%">
		<tr>
			...
			<td width="10%"><input type="button" class="BtnAction"
				value="新增" onClick="location='http://localhost:8080/moduls/archive/addEmployee.jsp'"></td>
			...
			<c:forEach items="${requestScope.employees}" var="emp">
				<tr>
					<td class="td_border" align="center">
						<a href="javascript:deleteRecord('deleteEmployeeByIdAction?id=${emp.id}')">
							<img src="image/wrong.gif" border="0"/>
						</a>
					</td>
					<td class="td_border" align="center">
<%--						<a href="javascript:findEmployeeByIdAction?id=${emp.id}">--%>
<%--							<img src="image/edit.gif" border="0"/>--%>
<%--						</a>--%>
						<a href="findEmployeeByIdAction?id=${emp.id}">
							<img src="image/edit.gif" border="0"/>
						</a>
					</td>
					...
					<td class="td_border"><c:if test="${emp.sex}">男</c:if> <c:if
						test="${!emp.sex}">女 </c:if></td>
