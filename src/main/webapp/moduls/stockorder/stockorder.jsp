...
<form:form action="stockorderAction" method="post" modelAttribute="stockorder">
	<table border="0" cellpadding="1" cellspacing="1" width="95%">
		<tr>
			<td align="right" width="10%" nowrap="nowrap">订货单编号</td>
			<td width="20%">
		...
		<tr>
			...
			<td width="20%">
				<form:input path="orderdate" cssClass="TextInput" onclick="c.show(this);"/>
			</td>
	...
	<div style="margin-left: 30px; margin-right: 0px">
		<table border="0" cellpadding="0" cellspacing="0" width="95%">
			<tr>
				...
				<td width="10%">
					<input type="button" class="BtnAction" value="新增" onclick="location='http://localhost:8080/moduls/stockorder/addStockorder.jsp'"/>
				</td>
				<td width="80%">&nbsp;</td>
			</tr>
		</table>
	...
	<div style="margin-left: 30px; margin-right: 0px">
		<table width="90%" border="1" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="10%" class="td_title">订货单编号</td>
...
<%--				<td width="13%" class="td_title">货物金额（元）</td>--%>
			...
			<c:if test="${!empty requestScope.stockorders}">
				<c:forEach items="${requestScope.stockorders}" var="sto">
					<tr>
						...
						<td class="td_border">${sto.merchandisenumber}</td>
<%--						<td class="td_border">${sto.price}</td>--%>
<%--						<td class="td_border">${sto.money}</td>--%>
						<td class="td_border">${sto.orderdate}</td>
