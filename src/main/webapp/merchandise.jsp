...
<form:form action="merchandiseAction" method="post" modelAttribute="merchandise">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="95%">
            <tr>
                ...
                <td width="10%"><input type="button" class="BtnAction"
                                       value="新增" onClick="location='http://localhost:8080/moduls/merchandise/addMerchandise.jsp'"></td>
    ...
    <div style="margin-left: 30px; margin-right: 0px">
        <table width="90%" border="1" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td width="10%" class="td_title">商品编号</td>
                <td width="15%" class="td_title">商品名称</td>
                <td width="15%" class="td_title">价格</td>
            </tr>
            <c:if test="${!empty requestScope.merchandises}">
                <c:forEach items="${requestScope.merchandises}" var="emp">
                    <tr>
                        <td class="td_border" align="center">
                            <a href="javascript:deleteRecord('deleteMerchandiseByIdAction?id=${emp.id}')">
                                <img src="image/wrong.gif" border="0"/>
                            </a>
                        </td>
                        <td class="td_border" align="center">
                            <a href="findMerchandiseByIdAction?id=${emp.id}">
                                <img src="image/edit.gif" border="0"/>
                            </a>
                        </td>
                        <td class="td_border">${emp.code}</td>
                        <td class="td_border">${emp.name}</td>
                        <td class="td_border">${emp.price}</td>
                    </tr>
                </c:forEach>
            </c:if>
        </table>
